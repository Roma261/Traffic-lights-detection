...
# Configurations
CFG_MODEL_PATH = "/Users/romantsoy/Desktop/Traffic-lights-detection/yolov8s.pt"
CFG_ENABLE_URL_DOWNLOAD = True
CFG_ENABLE_VIDEO_PREDICTION = True
if CFG_ENABLE_URL_DOWNLOAD:
    # Configure this if you set cfg_enable_url_download to True
    url = "https://archive.org/download/yolov8s/yolov8s.pt"
...
def main():
    ...
    st.header('📦 YOLOv8 Streamlit Deployment')
